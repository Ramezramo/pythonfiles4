...
#this update from file (E:\programming\programming\ABC_my_python_files\files 4\amazon scraper flutter api\_13_2_adding_comma_to_the_price.py)
#update[14] update name >(_correcting some scraping errors)

#update[14] what i will do (there is no response coming from the website i will fix this)




#update[14] started in [30/05/2023 22:25]
...
def searcher(amazon_link,the_word_search,country_name,currency_ammount):
	...
	if if_offline != '':#9
		...
		while True :
			try:
				print("=========="+amazon_link1+"==========")
				input("the link that i will search in")
...
#from this line i deleted some of codes that i put to import the settings from the jeson file
		...
		input_1 = input(f'\nfor search in all amazons windouuus hi  press {Fore.LIGHTYELLOW_EX}enter{Fore.RESET}!!!\nplease input {Fore.LIGHTYELLOW_EX}country num {Fore.RESET}: ').lower()#4.4 ,, 10.2 + [.lower()]
